...
const en = {
  ...
  download: {
    ...
    macDirect: "Download for Mac (.zip)",
  ...
  footer: {
    ...
    getMacDirect: "Direct download for Mac (.zip)",
...
const ru: typeof en = {
  ...
  footer: {
    ...
    getMacDirect: "Прямая загрузка для Mac (.zip)",
...
const kz: typeof en = {
  ...
  footer: {
    ...
    getMacDirect: "Mac үшін тікелей жүктеу (.zip)",
